...
- [ ] **App ID 登録**: Bundle ID `niki.dailio-jp` を Identifiers から登録
- [ ] **Capability 有効化** (App ID 編集画面)
  ...
  - [ ] In-App Purchase
  - [ ] App Groups
- [ ] **App Group 作成**: `group.niki.dailio-jp`（ウィジェット用、Phase 6.5 で使用）
- [ ] **iCloud Container 作成**: `iCloud.niki.dailio-jp`（CloudKit Dashboard でスキーマ初回保存）
...
- [ ] アプリ登録（プラットフォーム iOS、Bundle ID `niki.dailio-jp`、SKU = 任意）
- [ ] **In-App Purchase 3 つ作成**
  - [ ] `niki.dailio-jp.pro.monthly` 自動更新サブスク ¥200/月
  - [ ] `niki.dailio-jp.pro.yearly` 自動更新サブスク ¥1,980/年
  - [ ] `niki.dailio-jp.pro.lifetime` 非消耗型 ¥4,980
...
- [ ] File > New > Target > Widget Extension
  ...
  - Bundle ID: `niki.dailio-jp.widget`
- [ ] App Group `group.niki.dailio-jp` を main ターゲットと widget の両方で有効化
